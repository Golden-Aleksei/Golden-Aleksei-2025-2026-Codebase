...
public class RedTeleOp extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(startingPose == null ? new Pose() : startingPose); // Takes starting position from default position in auto beginning
        follower.update();
        ...
        pathChain = () -> follower.pathBuilder() //Lazy Curve Generation
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(38, 34))))
    ...
    public void loop() {
        ...
        if (gamepad1.dpadUpWasReleased() || gamepad1.dpadDownWasReleased()) {
            intake.setPower(0);
        }
